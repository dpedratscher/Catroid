...
public class SpriteListFragmentNewObjectFromSelection {
	@Rule
	...
	@Test
	public void testAddSpriteDefaultNameOfFile() {
		File testfile = null;
		...
		final Uri pathToFile = Uri.fromFile(testfile);
			...
			public void run() {
				baseActivityTestRule.getActivity()
						.onActivityResult(ProjectActivity.SPRITE_FILE, Activity.RESULT_OK,
								new Intent(Intent.ACTION_VIEW, pathToFile));
			}
		});
